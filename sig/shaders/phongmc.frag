...
void main() 
{
	// fColor = shade ( Pos, Norm, lPos, lInt[0], lInt[1], lInt[2], mColors[0], Color.rgb, mColors[2], mColors[3], mParams[0], Color.a );

	fColor = vec4(0,0,0,0);
	int i=0;
	if ( i<lNum ) { fColor += shade ( Pos, Norm, lPos[i], lInt[i][0], lInt[i][1], lInt[i][2], mColors[0], Color.rgb, mColors[2], mColors[3], mParams[0], Color.a ); i++; }
	if ( i<lNum ) { fColor += shade ( Pos, Norm, lPos[i], lInt[i][0], lInt[i][1], lInt[i][2], mColors[0], Color.rgb, mColors[2], mColors[3], mParams[0], Color.a ); i++; }
	if ( i<lNum ) { fColor += shade ( Pos, Norm, lPos[i], lInt[i][0], lInt[i][1], lInt[i][2], mColors[0], Color.rgb, mColors[2], mColors[3], mParams[0], Color.a ); i++; }
	if ( i<lNum ) { fColor += shade ( Pos, Norm, lPos[i], lInt[i][0], lInt[i][1], lInt[i][2], mColors[0], Color.rgb, mColors[2], mColors[3], mParams[0], Color.a ); i++; }
}
