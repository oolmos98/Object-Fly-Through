 ...
 * will allow you to print messages to the output. To stop using the trace, you 
 * just need to comment the defined GS_USE_TRACEx.
 *
 ...
 *
 * GS_TRACE_MSG can be defined by the user for customizing trace messages.
 ...
 *
 * Numbered messages can be activated by calling GS_USE_TRACE_COUNTER.
 **/

# ifndef GS_TRACE_H
# define GS_TRACE_H

# if defined(GS_TRACE_ASSERT) || defined(GS_USE_TRACE) || defined(GS_USE_TRACE1) || defined(GS_USE_TRACE2) || defined(GS_USE_TRACE3) || defined(GS_USE_TRACE4) || defined(GS_USE_TRACE5) || defined(GS_USE_TRACE6) || defined(GS_USE_TRACE7) || defined(GS_USE_TRACE8) || defined(GS_USE_TRACE9)
...
# if defined(GS_USE_TRACE_COUNTER)
static int GsTraceCounter=0;
# define GS_TRACE_CNT(i) i<<'-'<<(++GsTraceCounter)<<": "<<
# else
# define GS_TRACE_CNT(i) 
# endif

# if defined(GS_USE_TRACE1) || defined(GS_USE_TRACE)
# define GS_TRACE1(msg) GS_TRACE_OSTREAM << GS_TRACE_CNT(1) GS_TRACE_MSG << msg << gsnl
# else
# define GS_TRACE1(msg) 
# endif

# if defined(GS_USE_TRACE2) || defined(GS_USE_TRACE)
# define GS_TRACE2(msg) GS_TRACE_OSTREAM << GS_TRACE_CNT(2) GS_TRACE_MSG << msg << gsnl
# else
# define GS_TRACE2(msg) 
# endif

# if defined(GS_USE_TRACE3) || defined(GS_USE_TRACE)
# define GS_TRACE3(msg) GS_TRACE_OSTREAM << GS_TRACE_CNT(3) GS_TRACE_MSG << msg << gsnl
# else
# define GS_TRACE3(msg) 
# endif

# if defined(GS_USE_TRACE4) || defined(GS_USE_TRACE)
# define GS_TRACE4(msg) GS_TRACE_OSTREAM << GS_TRACE_CNT(4) GS_TRACE_MSG << msg << gsnl
# else
# define GS_TRACE4(msg) 
# endif

# if defined(GS_USE_TRACE5) || defined(GS_USE_TRACE)
# define GS_TRACE5(msg) GS_TRACE_OSTREAM << GS_TRACE_CNT(5) GS_TRACE_MSG << msg << gsnl
# else
# define GS_TRACE5(msg) 
# endif

# if defined(GS_USE_TRACE6) || defined(GS_USE_TRACE)
# define GS_TRACE6(msg) GS_TRACE_OSTREAM << GS_TRACE_CNT(6) GS_TRACE_MSG << msg << gsnl
# else
# define GS_TRACE6(msg) 
# endif

# if defined(GS_USE_TRACE7) || defined(GS_USE_TRACE)
# define GS_TRACE7(msg) GS_TRACE_OSTREAM << GS_TRACE_CNT(7) GS_TRACE_MSG << msg << gsnl
# else
# define GS_TRACE7(msg) 
# endif

# if defined(GS_USE_TRACE8) || defined(GS_USE_TRACE)
# define GS_TRACE8(msg) GS_TRACE_OSTREAM << GS_TRACE_CNT(8) GS_TRACE_MSG << msg << gsnl
# else
# define GS_TRACE8(msg) 
# endif

# if defined(GS_USE_TRACE9) || defined(GS_USE_TRACE)
# define GS_TRACE9(msg) GS_TRACE_OSTREAM << GS_TRACE_CNT(9) GS_TRACE_MSG << msg << gsnl
# else
