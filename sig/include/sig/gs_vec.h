...
{  public :
   ...
   public :
	...
	/*! Returns a GsVec2 with x,y coordinates. */
	GsVec2 xy () const { return GsVec2(x,y); }

	/*! Returns a GsVec2 with x,y coordinates. */
	GsVec2 xz () const { return GsVec2(x,z); }

	/*! Returns a GsVec2 with x,y coordinates. */
	GsVec2 yz () const { return GsVec2(y,z); }
	...
	friend GsVec barycentric ( const GsPnt& a, const GsPnt& b, const GsPnt& c, const GsVec &p );

	/*! Update the position of triangle (a,b,c) in order to maintain the baricentric
	...
	friend void transbarycentric ( GsPnt& a, GsPnt& b, GsPnt& c, const GsVec &k, const GsVec& v );
