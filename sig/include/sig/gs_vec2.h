...
/*! This "point typedef" is used only to coherently describe variables,
	making possible to distiguish points from vectors when
...
inline bool next ( const GsVec2& v1, const GsVec2& v2, float ds ) { return dist2(v1,v2)<=ds*ds; }

/*! Returns true if dist2(v1,v2)<=ds2, otherwise returns false. Implemented inline. */
inline bool next2 ( const GsVec2& v1, const GsVec2& v2, float ds2 ) { return dist2(v1,v2)<=ds2; }
...
/*! Transform p from window coordinates (in a w x h window) to normalized coordinates in [-1,1]. */
